...
void RUNETagGenerator::on_actionPrint_triggered()
{
    ...
    QSizeF page_mil = printer.pageLayout().pageSize().size(QPageSize::Unit::Millimeter);
    QSizeF pagePx = printer.pageLayout().pageSize().sizePixels(QPrinter::HighResolution);
